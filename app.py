...
<body>
    <video id="player" controls autoplay preload="auto" src="{{ url_for('stream_video', url=video_url_encoded) }}">
...
def stream_video():
    ...
    if 'Content-Type' not in response_headers:
        guessed_type, _ = mimetypes.guess_type(video_url)
        response_headers['Content-Type'] = guessed_type or 'video/mp4'
